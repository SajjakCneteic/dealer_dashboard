const CustomerOrderRow = ({ customerName, customerEmail, productName, productDetails, orderNumber, orderDate, status, confirmationEnabled }) => {
    return (
        <tr>
            ...
            <td className="px-2 py-4 whitespace-nowrap text-card-foreground">{orderNumber}</td>
            <td className="px-2 py-4  whitespace-nowrap text-card-foreground">{orderDate}</td>
